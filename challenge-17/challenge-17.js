...
const newName = text.replace(/Manuel Marques de Sousa/g, 'Luan Vitola');
console.log(newName);
...
const from = text.replace(/brasileiro/,'pelotense');
console.log(from);
...
// const noNumbers = text.replace(/[0-9]/g, '-'); //esse aqui também funciona.
...
const zero = text.replace(/[D-Z - a-h]/g, '0');
console.log(zero);
...
const quatro = text.replace(/a/gi, '4');
console.log(quatro);
...
const toUp = text.replace('O Centauro de Luvas', function toUp(phrase) {
