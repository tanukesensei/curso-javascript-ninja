...
*/
sum(25,25)
console.log(`A soma de 25 e 25 é igual a ${sum(25,25)}."`);
...
function calculator(operator) {
  return function calc(number1,number2) {
    let result;
    ...
    return console.log(`Resultado da operação: ${number1} ${operator} ${number2} = ${result}.`);
  };
}
