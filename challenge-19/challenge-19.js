...
let hasClass = function hasClass(markup, cssClass){
    let regex = new RegExp('class=["\'](?:[\\w\\s]+)?' + cssClass + '(?:[\\w\\s]+)?["\']');
    /** outra forma de fazer seria usando a regex abaixo com o .*  para procurar qualquer caractere, 
     * mas pode deixar o código mais lento já que ele vai procurar mais coisas do que se fosse indicando.
     * 
